...
- (void)openSummaryCreateForCurrentChannel {
    ...
    // origin_channel_type 走服务端 OctoSourceType (1=群聊/2=子区/3=私聊),
    // 不是 SDK WKChannelType (WK_GROUP=2/WK_COMMUNITY=4/WK_COMMUNITY_TOPIC=5/WK_PERSON=1)。
    // 之前直接灌 self.channel.channelType: 社区(4)/子区(5) 不在 {1,2,3} 被校验
    // 拒掉 ("origin_channel_type must be 1, 2, or 3"); 群/私聊数值碰巧合法, 但被
