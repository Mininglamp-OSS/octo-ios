...
> `WuKong*` 系列模块源自 [WuKongIM iOS SDK](https://github.com/WuKongIM/WuKongIMiOSSDK)（MIT），
> 保留其原始许可证。`WuKongBase/.../TelegramUtils/` 中仍包含部分来自
> [Telegram iOS](https://github.com/TelegramMessenger/Telegram-iOS) 的 GPL v2
> 代码（消息 cell 渲染所需）—— 如需 100% Apache 2.0 二进制做商业闭源分发，
> 请先参考 [TelegramUtils/README.md](Modules/WuKongBase/WuKongBase/Classes/Sections/Common/TelegramUtils/README.md)
> 处理这一部分。
